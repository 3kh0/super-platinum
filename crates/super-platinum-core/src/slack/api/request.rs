...
prejoin_dm_welcome_party_alert,internal_channel_invite,external_channel_invite,\
external_dm_invite,quietly_added_to_channel,channel,saved_reminder,list_record_edited";
...
pub fn activity_feed(
    ...
    fields.extend([
        ...
        ("automations_only", "false".to_owned()),
